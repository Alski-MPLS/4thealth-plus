...
def test_icmp_proto_service_does_not_match_tcp22():
    ...
    from app.planner.matching import AddressCatalog, PolicyMatcher
...
from app.planner.matching import AddressCatalog
...
from app.planner.matching import PolicyMatcher
